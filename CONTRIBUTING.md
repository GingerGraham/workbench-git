# Contributing to workbench-git

This is a `workbench` ecosystem module — it doesn't stand alone. It's
installed into a machine via `workbench-core`'s `wb add git`. Full
...
```sh
git clone https://github.com/GingerGraham/workbench-git.git
cd workbench-git
...
wb dev git
# — or directly:
wb track git --branch <your-branch>
```
